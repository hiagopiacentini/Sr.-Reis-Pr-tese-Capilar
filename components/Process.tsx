        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {STEPS.map((step, index) => (
            <motion.div 
              ...
              className="group relative p-6 md:p-8 rounded-2xl bg-dark-900/50 border border-gray-800 hover:border-gold-500 hover:bg-dark-900 transition-all duration-300 flex flex-col justify-between min-h-[200px]"
            >
              {/* Stylized Number */}
