    ...
    <Section className="bg-dark-950">
      <div className="text-center mb-10 md:mb-12">
        ...
        <p className="text-gray-400 text-sm md:text-base max-w-[22rem] mx-auto md:max-w-none [text-wrap:balance]">
          45 minutos separando um "eu inseguro" de um "eu completo".
        </p>
      </div>
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center justify-center">
          ...
          <AnimatePresence mode="wait">
            <motion.div 
              ...
              className="relative w-[80%] sm:w-[70%] md:w-1/2 aspect-square max-w-[320px] md:max-w-[400px] rounded-lg overflow-hidden shadow-lg border border-gray-800"
            >
          ...
          <AnimatePresence mode="wait">
             <motion.div 
              ...
              exit={{ opacity: 0, x: -20 }}
              transition={{ duration: 0.5 }}
              className="relative w-[80%] sm:w-[70%] md:w-1/2 aspect-square max-w-[320px] md:max-w-[400px] rounded-lg overflow-hidden shadow-[0_0_30px_rgba(255,230,0,0.2)] border border-gold-500/30"
            >
        ...
        <div className="mt-8 text-center">
            <p className="text-xl text-white font-medium mb-6 [text-wrap:balance]">{CASES[currentIndex].label}</p>
